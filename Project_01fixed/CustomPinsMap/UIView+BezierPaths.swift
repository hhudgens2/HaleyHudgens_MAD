...
//I'm using this to create custom shapes for button and call out view
...
func dialogBezierPathWithFrame(_ frame: CGRect, arrowOrientation orientation: UIImageOrientation, arrowLength: CGFloat = 20.0) -> UIBezierPath {
    ...
    // Rotate path to fit orientation
    switch orientation {
    case .up, .upMirrored:
    break
...
//adapted from http://digitalleaves.com/blog/2015/07/bezier-paths-in-practice-i-from-basic-shapes-to-custom-designable-controls/
